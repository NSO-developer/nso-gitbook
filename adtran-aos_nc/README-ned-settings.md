...
----------------------
  ...
  global
    /ncs:devices/global-settings/ned-settings/adtran-aos_nc/
  profile
    /ncs:devices/ncs:profiles/profile:<name>/ned-settings/adtran-aos_nc/
  device
    /ncs:/device/devices/device:<name>/ned-settings/adtran-aos_nc/
  ...
  From the NSO CLI the device instance NED settings for this NED are available under:
   ...
   ```
   # config
   # devices device dev-1 ned-settings adtran-aos_nc
...
-------------------------------
  ...
  This file describes the ned-settings for adtran-aos_nc.


# 2. ned-settings adtran-aos_nc transaction
-------------------------------------------
  ...
  Settings affecting different aspects of NSO transactions towards device.
    ...
    - transaction trans-id-method <enum> (default config-data)
      ...
      Either of:
        ...
        - devices device ned-settings adtran-aos_nc transaction use-maapi-setvalues <true|false>
      ...
      OR:
        ...
        - devices device ned-settings adtran-aos_nc transaction use-maapi-load-config-cmds <true|false>
...
## 2.1. ned-settings adtran-aos_nc transaction ignore-rpc-errors
----------------------------------------------------------------
...
## 2.2. ned-settings adtran-aos_nc transaction extra-get-config-paths
---------------------------------------------------------------------
...
## 2.3. ned-settings adtran-aos_nc transaction exclude-namespaces
-----------------------------------------------------------------
...
## 2.4. ned-settings adtran-aos_nc transaction inject-meta-data
---------------------------------------------------------------
...
## 2.5. ned-settings adtran-aos_nc transaction config-replace-patterns inbound
------------------------------------------------------------------------------
...
## 2.6. ned-settings adtran-aos_nc transaction config-replace-patterns outbound
-------------------------------------------------------------------------------
...
# 3. ned-settings adtran-aos_nc connection
------------------------------------------
...
## 3.1. ned-settings adtran-aos_nc connection capabilities
----------------------------------------------------------
...
### 3.1.1. ned-settings adtran-aos_nc connection capabilities regex-exclude
---------------------------------------------------------------------------
...
### 3.1.2. ned-settings adtran-aos_nc connection capabilities regex-include
---------------------------------------------------------------------------
...
### 3.1.3. ned-settings adtran-aos_nc connection capabilities inject
--------------------------------------------------------------------
...
## 3.2. ned-settings adtran-aos_nc connection ssh
-------------------------------------------------
  ...
  Settings related to the SSH client used by the NED to connect to the device.
    ...
    - ssh host-key auto-fetch <true|false> (default false)
      ...
      To view the stored known host-keys, you can for example do the below in ncs_cli:
         ...
         admin@ncs# show devices device dev-1 ned-settings adtran-aos_nc-oper known-host-keys
      ...
      tool like this:
       ...
       $ ncs_cmd -c "mdel /ncs:devices/device{dev-1}/ned-settings/adtran-aos_nc-oper/known-host-keys"
...
# 4. ned-settings adtran-aos_nc proxy
-------------------------------------
  ...
  globally, or in a profile, which is a convenient way to switch all or some devices to connect through a jump-host.
    ...
    - proxy remote-port <uint16>
      ...
      Either of:
        ...
        - devices device ned-settings adtran-aos_nc proxy remote-name <string>

          User name on the device behind the proxy.

        - devices device ned-settings adtran-aos_nc proxy remote-password <string>

          Password on the device behind the proxy.

      OR:

        - devices device ned-settings adtran-aos_nc proxy authgroup <string>
...
# 5. ned-settings adtran-aos_nc live-status
-------------------------------------------
...
## 5.1. ned-settings adtran-aos_nc live-status regex-exclude
------------------------------------------------------------
...
## 5.2. ned-settings adtran-aos_nc live-status cli
--------------------------------------------------
...
### 5.2.1. ned-settings adtran-aos_nc live-status cli auto-prompts
------------------------------------------------------------------
...
# 6. ned-settings adtran-aos_nc logger
--------------------------------------
...
# 7. ned-settings adtran-aos_nc developer
-----------------------------------------
