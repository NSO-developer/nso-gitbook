...
>
> When NCS is started by the systemd service generated by the
> --system-install option to the NCS installer, the environment variable
> NCS_RELOAD_PACKAGES can be set to 'true' in
> /etc/ncs/ncs.systemd.conf to attempt a package reload.
