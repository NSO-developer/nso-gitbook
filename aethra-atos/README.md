...
------------
  ...
  This document describes the aethra-atos NED.
...
------------------------------
  ...
  It is assumed the NED package `ncs-<NSO version>-aethra-atos-<NED version>.signed.bin` has already
  ...
  1. Extract the NED package and verify its signature:
      ...
      > chmod u+x ncs-6.0-aethra-atos-1.0.1.signed.bin
      > ./ncs-6.0-aethra-atos-1.0.1.signed.bin
      ```
  ...
  2. In case the signature can not be verified (for instance if no internet connection),
     do as below instead:
      ...
      ```
      > ./ncs-6.0-aethra-atos-1.0.1.signed.bin --skip-verification
      ```
  ...
  3. The result of the extraction shall be a tar.gz file with the same name as the .bin file:
      ...
      ```
      > ls *.tar.gz
      ncs-6.0-aethra-atos-1.0.1.tar.gz
      ```
...
-----------------------
  ...
  1. Untar the tar.gz file. This creates a new sub-directory named:
     `aethra-atos-<NED major digit>.<NED minor digit>`:

     ```
     > tar xfz ncs-6.0-aethra-atos-1.0.1.tar.gz
     > ls -d */
     aethra-atos-cli-1.0
     ```
  ...
  2. Install the NED into NSO, using the ncs-setup tool:
     ...
     ```
     > ncs-setup --package aethra-atos-cli-1.0 --dest $NSO_RUNDIR
     ```
  ...
  ```
    > ncs-setup --package ncs-6.0-aethra-atos-1.0.1.tar.gz --dest $NSO_RUNDIR
    > ncs_cli -C -u admin
    admin@ncs# packages reload
    reload-result {
      package aethra-atos-cli-1.0
  ...
  ```
  > export NED_ROOT_DIR=$NSO_RUNDIR/packages/aethra-atos-cli-1.0
  ```
...
------------------------
  ...
  2. Start a NSO CLI session and fetch the NED package:
     ...
     admin@ncs# software packages fetch package-from-file \
               /tmp/ned-package-store/ncs-6.0-aethra-atos-1.0.tar.gz
     admin@ncs# software packages list
     package {
      name ncs-6.0-aethra-atos-1.0.tar.gz
      installable
     }
     ```
  ...
  3. Install the NED package (add the argument replace-existing if a previous version has been loaded):
     ...
     ```
     admin@ncs# software packages install aethra-atos-1.0
     admin@ncs# software packages list
     package {
      name ncs-6.0-aethra-atos-1.0.tar.gz
      installed
  ...
  4. Load the NED package
     ...
     admin@ncs# software packages list
     package {
       name ncs-6.0-aethra-atos-cli-1.0
       loaded
     }
     ```
...
-------------------------------
  ...
  - Configure a new device instance (example: dev-1):
    ...
    admin@ncs(config)# devices device dev-1 device-type cli ned-id aethra-atos-cli-1.0
...
-----------------------------------
  ...
  `$NSO_RUNDIR/logs/ned-aethra-atos-cli-1.0-<device name>.trace`
  ...
  4. Configure the log level for printouts to the trace file:
     ...
     ```
     admin@ncs(config)# devices device dev-1 ned-settings aethra-atos logger \
     ...
     ```
     admin@ncs(config)# devices device global-settings ned-settings aethra-atos logger \
                       level [debug | verbose | info | error]
     admin@ncs(config)# commit
     ```
  ...
  **IMPORTANT**:
  ...
  3. Enable Java logging with level all from the NED package:
     ...
     ```
     admin@ncs(config)# java-vm java-logging logger com.tailf.packages.ned.atos \
                       level level-all
     admin@ncs(config)# commit
     ```
  ...
  4. Configure the NED to log to the Java logger
     ...
     ```
     admin@ncs(config)# devices device dev-1 ned-settings aethra-atos logger java true
     admin@ncs(config)# commit
     ```
     ...
     ```
     admin@ncs(config)# devices global-settings ned-settings aethra-atos logger java true
     admin@ncs(config)# commit
     ```
...
--------------------------------------------------
  ...
  **Issues like bugs and errors shall always be reported to the Cisco NSO NED team through
  ...
  1. Enable full debug logging in the NED
     ...
     ncs_cli -C -u admin
     admin@ncs# configure
     admin@ncs(config)# devices device dev-1 ned-settings aethra-atos logging level debug
     admin@ncs(config)# commit
     ```
...
------------------------
  ...
  > devices device dev-1 ned-settings aethra-atos logger level debug
  > commit
  ```
