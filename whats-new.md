...
A new [document](https://cisco-tailf.gitbook.io/nso-docs/resources/best-practices/nso-on-kubernetes) covering best practices for Kubernetes has been added to the documentation set.
