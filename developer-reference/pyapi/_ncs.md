...
<summary>has_child_action(...)</summary>

Method:

```python
has_child_action() -> bool
```

Returns True if CsNode or any of its descendants has YANG 'tailf:action' statement(s).

</details>

<details>

<summary>has_child_conf_action(...)</summary>

Method:

```python
has_child_conf_action() -> bool
```

Returns True if CsNode or any of its descendants has YANG 'tailf:cli-configure-mode' statement(s).

</details>

<details>

<summary>has_child_oper_action(...)</summary>

Method:

```python
has_child_oper_action() -> bool
```

Returns True if CsNode or any of its descendants has YANG 'tailf:cli-operational-mode' statement(s).

</details>

<details>

<summary>has_child_read_only(...)</summary>

Method:

```python
has_child_read_only() -> bool
```

Returns True if CsNode is an operational (read-only) node, or if any of its descendants are operational nodes.

</details>

<details>

<summary>has_child_read_write(...)</summary>

Method:

```python
has_child_read_write() -> bool
```

Returns True if CsNode node is a configuration (read-write) node, or if any of its descendants are configuration data nodes.
...
Returns True if CsNode has a YANG 'tailf:prompt' statement.

</details>

<details>

<summary>has_servicepoint(...)</summary>

Method:

```python
has_servicepoint() -> bool
```

Returns True if CsNode has YANG 'ncs:servicepoint' statement(s).
...
<summary>doc_description(...)</summary>

Method:

```python
doc_description() -> Union[str, None]
```

Returns CsNodeInfo document description.
...
CS_NODE_CMP_USER = 3
CS_NODE_HAS_CHILD_ACTION = 524288
CS_NODE_HAS_CHILD_CONF_ACTION = 2097152
CS_NODE_HAS_CHILD_OPER_ACTION = 1048576
CS_NODE_HAS_CHILD_READ_ONLY = 4194304
CS_NODE_HAS_CHILD_READ_WRITE = 8388608
CS_NODE_HAS_DISPLAY_WHEN = 1024
CS_NODE_HAS_DOC_DESCRIPTION = 16777216
CS_NODE_HAS_META_DATA = 2048
CS_NODE_HAS_MOUNT_POINT = 32768
CS_NODE_HAS_PROMPT = 131072
CS_NODE_HAS_SERVICEPOINT = 262144
...
LF_OR = 0
LF_ORIGIN = 6
LIB_API_VSN = 134676480
LIB_API_VSN_STR = '08070000'
LIB_PROTO_VSN = 87
LIB_PROTO_VSN_STR = '87'
LIB_VSN = 134676480
LIB_VSN_STR = '08070000'
LISTENER_CLI = 8
LISTENER_IPC = 1
LISTENER_NETCONF = 2
LISTENER_SNMP = 4
