...
----------------------
  ...
  global
    /ncs:devices/global-settings/ned-settings/opengear-cm/
  profile
    /ncs:devices/ncs:profiles/profile:<name>/ned-settings/opengear-cm/
  device
    /ncs:/device/devices/device:<name>/ned-settings/opengear-cm/
  ...
  From the NSO CLI the device instance NED settings for this NED are available under:
   ...
   ```
   # config
   # devices device dev-1 ned-settings opengear-cm
...
# 2. ned-settings opengear-cm developer
---------------------------------------
...
# 3. ned-settings opengear-cm proxy
-----------------------------------
...
# 4. ned-settings opengear-cm proxy-2
-------------------------------------
...
# 5. ned-settings opengear-cm connection
----------------------------------------
...
# 6. ned-settings opengear-cm transaction
-----------------------------------------
...
# 7. ned-settings opengear-cm console
-------------------------------------
...
## 7.1. ned-settings opengear-cm console extension warning
----------------------------------------------------------
...
## 7.2. ned-settings opengear-cm console extension command
----------------------------------------------------------
...
## 7.3. ned-settings opengear-cm console extension pattern
----------------------------------------------------------
...
## 7.4. ned-settings opengear-cm console extension action
---------------------------------------------------------
...
### 7.4.1. ned-settings opengear-cm console extension action state
------------------------------------------------------------------
...
# 8. ned-settings opengear-cm logger
------------------------------------
