...
<figure><img src="https://pubhub.devnetcloud.com/media/nso-guides-6.1/docs/nso_lsa/pics/layered-service-arch-1.png#developer.cisco.com" alt="" width="563"><figcaption><p>Layered CFS/RFS architecture</p></figcaption></figure>
...
A distributed system can push the overall throughput way beyond what a single instance can do. But you will achieve a much better outcome by first focusing on eliminating the bottlenecks in the provisioning code, as discussed in [Scaling and Performance Optimization](../../development/connected-topics/scaling-and-performance-optimization.md). Only when that proves insufficient, consider deploying LSA.
...
<figure><img src="https://pubhub.devnetcloud.com/media/nso-guides-6.1/docs/nso_lsa/pics/request-flow.png#developer.cisco.com" alt="" width="563"><figcaption><p>LSA Request Flow</p></figcaption></figure>
...
<figure><img src="https://pubhub.devnetcloud.com/media/nso-guides-6.1/docs/nso_lsa/pics/lsa-example-22.png#developer.cisco.com" alt="" width="563"><figcaption><p>Example LSA architecture</p></figcaption></figure>
...
<figure><img src="https://pubhub.devnetcloud.com/media/nso-guides-6.1/docs/nso_lsa/pics/network.jpg#developer.cisco.com" alt=""><figcaption><p>VPN network</p></figcaption></figure>
...
<figure><img src="https://pubhub.devnetcloud.com/media/nso-guides-6.1/docs/nso_lsa/pics/mpls-vpn.png#developer.cisco.com" alt="" width="563"><figcaption><p>NSO topology</p></figcaption></figure>

\
We want an NSO architecture that looks like this:

<figure><img src="https://pubhub.devnetcloud.com/media/nso-guides-6.1/docs/nso_lsa/pics/mpls-vpn-lsa.png#developer.cisco.com" alt="" width="563"><figcaption><p>NSO LSA topology</p></figcaption></figure>
...
If that is not feasible, the solution is to run a Multi-Version Deployment. Along with all of the requirements, the section [Multi-Version Deployment](layered-service-architecture.md#ncs\_lsa.lsa\_setup.multi\_version) describes a major difference from the Single Version variant: the upper CFS node uses a version-specific `cisco-nso-nc-X.Y` NED ID to refer to lower RFS nodes. That means, if you switch to a Multi-Version Deployment, or perform a major upgrade of the lower-layer RFS node, the `ned-id` should change accordingly. However, do not change it directly but follow the correct NED upgrade procedure described in the section called [NED Migration](../management/nso-packages.md#ug.package\_mgmt.ned\_migration). Briefly, the procedure consists of these steps:
