...
Example implementations of this System Install workflow are provided in [examples.ncs/high-availability/upgrade-basic/upgrade_pkgs_sys.sh](https://github.com/NSO-developer/nso-examples/tree/6.5/high-availability/upgrade-cluster/upgrade_pkgs_sys.sh) and [examples.ncs/high-availability/upgrade-cluster/upgrade_pkgs_sys.sh](https://github.com/NSO-developer/nso-examples/tree/6.5/high-availability/upgrade-cluster/upgrade_pkgs_sys.sh).
