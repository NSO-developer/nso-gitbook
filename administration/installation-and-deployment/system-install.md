...
Run the `sh nso-VERSION.linux.x86_64.installer.bin --help` command to view additional help on running binaries. More details can be found in the [ncs-installer(1)](https://developer.cisco.com/docs/nso-guides-6.3/manual-pages/#man.1.ncs-installer) manual page included with NSO.
...
For more information on the `ncs-installer`, see the [ncs-installer(1)](https://developer.cisco.com/docs/nso-guides-6.1/#!manual-pages/man.1.ncs-installer) man page.
