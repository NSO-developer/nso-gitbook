...
The installation program will unpack the NSO manual pages from the documentation archive, allowing you to use the `man` command to view them. The manual pages are also available in PDF format and from the online documentation located on [NCS man-pages, Volume 1](../../man/section1.md) in Manual Pages.
...
For more information on the `ncs-installer`, see the [ncs-installer(1)](../../man/section1.md) man page.
