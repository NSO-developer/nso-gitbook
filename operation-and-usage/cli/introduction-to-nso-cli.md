...
Parts of the CLI behavior can be controlled from the `ncs.conf` file. See the [ncs.conf(5)](../../man/ncs.conf.5.md) in Manual Pages manual page for a comprehensive description of all the options.
