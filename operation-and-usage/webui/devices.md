...
3.  In the group details page, add users to the newly created group:
    ...
    <div data-gb-custom-block data-tag="hint" data-style="info" class="hint hint-info"><p>If a default map is desired for unknown/unmapped users, use the <strong>Set default-map</strong> option.</p></div>
