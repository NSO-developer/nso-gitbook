...
# Resource Manager API Guide (4.x)
...
* [NSO Installation](https://nso-docs.cisco.com/guides/administration/installation-and-deployment)
* [NSO Operation and Usage Guide](https://nso-docs.cisco.com/guides/operation-and-usage/get-started)
