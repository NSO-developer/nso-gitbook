...
The web server can be configured through settings in `ncs.conf` . See the Manual Pages section [Configuration Parameters](https://developer.cisco.com/docs/nso-api-6.4/ncs-man-pages-volume-5/#tailf-ncs-config.yang\_config).
