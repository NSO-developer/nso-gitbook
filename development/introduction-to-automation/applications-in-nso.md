...
The kicker system is further described in [Kicker](../development/kicker.md).
...
{% content-ref url="../concepts/implementing-services.md" %}
[implementing-services.md](../concepts/implementing-services.md)
{% endcontent-ref %}
