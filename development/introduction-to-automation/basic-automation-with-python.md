...
{% hint style="info" %}
See [examples.ncs/getting-started/basic-automation](https://github.com/NSO-developer/nso-examples/tree/6.4/getting-started/basic-automation) for an example implementation.
{% endhint %}
