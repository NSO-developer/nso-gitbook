...
A good starting point for learning how to create a Web UI package that uses the [JSON-RPC API](broken-reference) to query data from NSO is the [examples.ncs/northbound-interfaces/webui](https://github.com/NSO-developer/nso-examples/tree/6.4/northbound-interfaces/webui) example.
