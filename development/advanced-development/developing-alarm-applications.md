...
This section focuses on how to manipulate the NSO alarm table using the dedicated Alarm APIs. Make sure that the concepts in the [Alarm Manager ](../../operation-and-usage/cli-1/alarm-manager.md)introduction are well understood before reading this section.
