...
See [examples.ncs/device-manager/cli-ned](https://github.com/NSO-developer/nso-examples/tree/6.4/device-management/cli-ned) for an example of a Java implementation serving any YANG models, including those that come with the example.
