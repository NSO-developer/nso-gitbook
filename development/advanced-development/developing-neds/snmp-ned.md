...
All MIB annotations for a particular MIB are written to a file with the file suffix `.miba`. See [mib\_annotations(5)](../../../man/mib_annotations.5.md) in manual pages for details.
