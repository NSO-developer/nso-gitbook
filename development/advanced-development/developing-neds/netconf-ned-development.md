...
The NSO example under [examples.ncs/device-management/netconf-ned](https://github.com/NSO-developer/nso-examples/tree/6.7/device-management/netconf-ned) implements two shell scripts that use different tools to build a NETCONF NED from a simulated hardware chassis system controller device.
...
For a demo of the steps below, see the README in the [examples.ncs/device-management/netconf-ned](https://github.com/NSO-developer/nso-examples/tree/6.7/device-management/netconf-ned) example and run the demo.sh script.
...
NSO can now configure the device, state data can be read, actions can be executed, and notifications can be received. See the [examples.ncs/device-management/netconf-ned](https://github.com/NSO-developer/nso-examples/tree/6.7/device-management/netconf-ned) `demo.sh` example script for a demo.

## Using the NETCONF NED Builder Tool <a href="#d5e9185" id="d5e9185"></a>

For a demo of the steps below, see README in the [examples.ncs/device-management/netconf-ned](https://github.com/NSO-developer/nso-examples/tree/6.7/device-management/netconf-ned) example and run the `demo_nb.sh` script.
...
NSO can now configure the device, state data can be read, actions can be executed, and notifications can be received. See the [examples.ncs/device-management/netconf-ned](https://github.com/NSO-developer/nso-examples/tree/6.7/device-management/netconf-ned) `demo_nb.sh` example script for a demo.
