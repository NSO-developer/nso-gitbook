...
The [examples.ncs/device-management/](https://github.com/NSO-developer/nso-examples/tree/6.5/device-management/xmlrpc-device)[generic-ned](https://github.com/NSO-developer/nso-examples/tree/6.5/device-management/generic-ned) example in the NSO examples collection implements a generic NED that speaks XML-RPC to 3 HTTP servers. The HTTP servers run the Apache XML-RPC server code and the NED code manipulates the 3 HTTP servers using a number of predefined XML RPC calls.
...
The [examples.ncs/device-management/](https://github.com/NSO-developer/nso-examples/tree/6.5/device-management/xmlrpc-device)[generic-ned](https://github.com/NSO-developer/nso-examples/tree/6.5/device-management/generic-ned) example is a good example to start with if we wish to write a generic NED. It manages a set of devices over the XML-RPC protocol. In this example, we have:
...
The [examples.ncs/device-management/g](https://github.com/NSO-developer/nso-examples/tree/6.5/device-management/xmlrpc-device)[eneric-ned](https://github.com/NSO-developer/nso-examples/tree/6.5/device-management/generic-ned) example managed device, a fictitious XML-RPC device, contains a YANG snippet:
