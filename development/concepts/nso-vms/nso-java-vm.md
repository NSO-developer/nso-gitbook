...
## JMX Interface <a href="#d5e1340" id="d5e1340"></a>
...
<figure><img src="https://pubhub.devnetcloud.com/media/nso-guides-6.1/docs/nso_development/pics/jconsole-auth.png#developer.cisco.com" alt="" width="375"><figcaption><p>jconsole login window</p></figcaption></figure>
...
{% code title="Example: ApplicationMuxManager JMX Bean" %}
```
package com.tailf.ncs.ctrl;
/**
