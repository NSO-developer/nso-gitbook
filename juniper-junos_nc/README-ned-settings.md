...
## 2.5. ned-settings juniper-junos_nc transaction config-replace-patterns inbound
---------------------------------------------------------------------------------
...
## 2.6. ned-settings juniper-junos_nc transaction config-replace-patterns outbound
----------------------------------------------------------------------------------
